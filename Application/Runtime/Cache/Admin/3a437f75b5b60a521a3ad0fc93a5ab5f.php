                            ...
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($Positions)): $i = 0; $__LIST__ = $Positions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><span attr-status="<?php if( $position['status'] == 1): ?>0
                                            ...
                                            id="singcms-on-off"><?php echo (getMenuStatus($position["status"])); ?></span></td>
                                        <td><span class="glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit"
                                                  attr-id="<?php echo ($position["id"]); ?>"></span>
                                            <a href="javascript:void(0)" attr-id="<?php echo ($position["id"]); ?>" id="singcms-delete"
                                               attr-a="position" attr-message="删除"
