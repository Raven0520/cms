                ...
                <div class="col-lg-6">
                    ...
                    <form class="form-horizontal" id="singcms-form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="<?php echo ($vo["title"]); ?>" type="text" name="title" class="form-control" id="inputname"
                                       placeholder="请填写标题">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="position_id">
                                    <?php if(is_array($positions)): foreach($positions as $key=>$position): ?><option value="<?php echo ($position["id"]); ?>"
                                        <?php if($position['id'] == $vo['position_id']): ?>selected = "selected"<?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <img style="display: none" id="upload_org_code_img" src="<?php echo ($vo["thumb"]); ?>" width="150"
                                     height="150">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="<?php echo ($vo["url"]); ?>" type="text" class="form-control" name="url" id="inputPassword3"
                                       placeholder="请url地址">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input value="<?php echo ($vo["news_id"]); ?>" type="text" name="news_id" class="form-control"
                                       id="inputname" placeholder="如果和文章无关联的可以不添加文章id">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <?php if($vo["status"] == 1): ?>checked = "checked"<?php endif; ?>
                                > 开启
                                <input type="radio" name="status" id="optionsRadiosInline2" value="0"
                                <?php if($vo["status"] == 0): ?>checked = "checked"<?php endif; ?>
                                > 关闭
                            </div>
